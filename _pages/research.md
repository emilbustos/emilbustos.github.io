...
<p align="center">
  <img width="800" height="400" src="/assets/mean_did_pos_inc_pens.jpg">
</p>
...
[IFN WP](https://www.ifn.se/publikationer/working-papers/2024/1495/)
...
[IFN WP](https://www.ifn.se/publikationer/working-papers/2024/1494/)
...
Westudy how financing constraints affect the cash holdings of small and mediumsized enterprises. There has been little empirical work on this topic, even though these firms often face financial constraints. We contribute by using detailed data on credit ratings in Sweden as a measure of financial constraints. We then use panel regressions and a regression-discontinuity analysis to estimate the relationship between access to credit and cash holdings. Our analysis finds no causal effect of credit ratings on cash holdings.

[IFN WP](https://www.ifn.se/publikationer/working-papers/2024/1493/)

<br><br><br><br><br>

## How Well do Firms Recover from Idiosyncratic Shocks? Evidence from Insurance Claims ##
...
(with [Viking Waldén](https://vikingwalden.github.io/))

We study the effect of housing, neighborhoods, and tenancy on socio-economic outcomes such as earnings and family formation. We exploit a feature of the Swedish housing market, where apartments are offered sequentially based on waiting time, as exogenous tenancy allocation. Becoming a tenant increases the probability of moving and induces moves to neighborhoods with different characteristics than they otherwise would have lived in. Receiving tenancy in poor neighborhoods induces moves to poorer neighborhoods than applicants otherwise would have lived in while receiving tenancy in rich neighborhoods makes applicants move to richer neighborhoods. Tenancy, however, leaves labor supply and family formation unaffected regardless of where the apartment is located.  
